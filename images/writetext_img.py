...
def main():
    ...
    ## Set add_labels to True to omit class labels on the bounding boxes
    add_labels = False
    for i in range(len(pred_sv_xyxy)):
        image_with_boxes = draw_boxes_and_labels(image, pred_sv_xyxy, predicted_classes, add_labels)
